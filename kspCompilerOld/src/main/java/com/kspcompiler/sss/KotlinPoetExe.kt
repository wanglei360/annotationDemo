...
internal fun KSTypeParameter.toTypeVariableName(typeParamResolver: TypeParameterResolver, ): TypeVariableName {
    ...
    typeVarBounds.forEach {
        list.add(it)
    }
    return TypeVariableName(typeVarName, bounds = list, variance = typeVarVariance)
}
